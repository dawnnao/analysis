...
dateStartInput = '2014-07-28';
dateEndInput = '2014-07-28';

nickName = {'VIB'};
dimens = [3600*50 55]; % [number of points , number of channels]
...
%     xlabel = 'Date';
    ...
    ax.Title.String = titleName_VIB{m};
...
%     fig.Position = [0 0.75 1 0.08];  % control figure's position
    ...
    % save
    saveas(gcf, sprintf('%s/raw_VIB_chan_%d.tif', dir.figFolder, m));
