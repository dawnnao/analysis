...
for d = dateStart : dateEnd
    ...
    for h = 0 : 23
        ...
        if exist([dir.folderSource dir.dateFolderRead], 'dir')
            ...
            maxBlocks = calcuStats('max', dataTemp.data, nBlocks, nickName, referPoints);
            maxAll = cat(1, maxAll, maxBlocks);
            clear maxBlocks
            
            rmsBlocks = calcuStats('rms', dataTemp.data, nBlocks, nickName, referPoints);
            rmsAll = cat(1, rmsAll, rmsBlocks);
            clear rmsBlocks
            
            minBlocks = calcuStats('min', dataTemp.data, nBlocks, nickName, referPoints);
...
%     ax.YLabel.String = 'Delection (mm)';                                   % change here
